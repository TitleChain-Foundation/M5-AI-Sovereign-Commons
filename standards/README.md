...
| Standard | Start here when reviewing |
| --- | --- |
| [M5-AIGOV-001 — AI Governance and Deterministic Authorization](M5-AIGOV-001.md) | Principals, delegation, M5Canon controls, agents, tools, budgets, approvals, and evidence |
...
- [Documentation map](../docs/README.md) for explanatory profiles and crosswalks.
- [Schemas](../schemas/README.md) for machine-readable record shapes.
- [Synthetic examples](../examples/README.md) for non-authoritative instances.
- [Tests and validation](../tests/README.md) for the cases currently exercised.
